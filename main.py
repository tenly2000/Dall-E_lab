    ...
    while True:
        ...
        if option == "1":
            ...
            with Image.open(image_path) as img:
                create_variations(img, image_path)
        elif option == "0":
...
## Open an image file
  with Image.open(image_path) as img:
    ...
    resized_img.save(f'resized_image_{option}.png')
    print(f"Your given image was resized and saved under `resized_image_{option}.png` ")
...
def create_variations(img, imagepath):
